...
set.seed(983745)
results_d3_perturb <- foreach(i=1:Nrep, .packages = c("r.jive", "CCAGFA")) %dorng% {
  # generate the model
  data <- generateModel2_perturb(n = 100, pvec = c(100,100,100), snr = 1, orthogonalV = T)
  # Prepare output
...
save(results_d3_perturb, file = "Results_d3_perturb.Rda")
